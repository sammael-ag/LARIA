export const faqArticles = [
  ...
  },
  {
    ...
    content: `
      ...
      <div class="faq-image-container" style="text-align: center; margin: 20px 0;">
        <img src="./images/panorama1.png" alt="Cesta vytvorenia vizitky v systéme LARIA" style="max-width: 100%; width: 550px; height: auto; border-radius: 4px; cursor: pointer;" />
  ...
  content: `
    ...
    <img src="./images/panorama2.png" alt="Vyhľadanie a pridanie kontaktu" />
  ...
  content: `
    ...
    <img src="./images/panorama3.png" alt="Obnova účtu v systéme LARIA" />
