/**
 * LARIA v2.0: SettingsScreen
 * Master: Sammael | Muse: Aria
 * Status: CORE_CONFIG_STABLE
 */
    ...
    <SafeAreaView style={[G.mainBackground, { flex: 1 }]}>
      <ScrollView contentContainerStyle={{ padding: 25, paddingBottom: 60 }}>
        ...
        <View style={{ marginTop: 20, marginBottom: 35, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
          <View>
            <Text style={[G.atelierTitle, { fontSize: 26, letterSpacing: 5 }]}>CORE CONFIG</Text>
            <Text style={[G.statusTextSmall, { color: ACCENT, fontSize: 10 }]}>
               Sammael Engine v8.0.4 | Rákoš Base Matrix
            </Text>
          </View>
          <TouchableOpacity onPress={() => navigation.goBack()}>
            <Text style={G.statusTextSmall}>[ ZATVORIŤ ]</Text>
          </TouchableOpacity>
        </View>
        ...
        {/* AKTÍVNY UZOL */}
        <View style={[G.card, { padding: 20, borderLeftWidth: 3, borderLeftColor: ACCENT, backgroundColor: 'rgba(241,196,15,0.02)', marginBottom: 40 }]}>
